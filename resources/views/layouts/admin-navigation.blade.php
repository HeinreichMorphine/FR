<nav x-data="{ open: false }" class="bg-brand-card/50 backdrop-blur-md border-b border-white/10">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.shelters.index')" :active="request()->routeIs('admin.shelters.*')" class="text-gray-300 hover:text-white">
                        {{ __('Shelters') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.reports.index')" :active="request()->routeIs('admin.reports.*')" class="text-gray-300 hover:text-white">
                        {{ __('Reports') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.news.index')" :active="request()->routeIs('admin.news.*')" class="text-gray-300 hover:text-white">
                        {{ __('News') }}
                    </x-nav-link>
                </div>
            </div>
